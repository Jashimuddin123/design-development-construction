    ...
    return (
        <div className="px-4 md:px-8 lg:px-16 py-8">
            <div className="text-center mb-8">
                <p className="text-red-500 text-xl mb-2 flex items-center justify-center gap-2"><GoArrowLeft />Our Work Process <GoArrowRight /></p>
                <h1 className="text-blue-950 font-bold text-2xl md:text-4xl lg:text-5xl">How Does Architek Work</h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="relative group card bg-base-100 w-full shadow-xl overflow-hidden">
                    ...
                    <div className="card-body items-center text-center relative z-10 group-hover:text-white">
                        <h2 className="card-title text-lg md:text-xl font-semibold">General Contract</h2>
                ...
                <div className="relative group card bg-base-100 w-full shadow-xl overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-50 transition duration-300"></div>
                    <div className="card-body items-center text-center relative z-10 group-hover:text-white">
                        <h2 className="card-title text-lg md:text-xl font-semibold">Project Planning</h2>
                        <p className="text-sm md:text-base">If a dog chews shoes whose shoes does he choose?</p>
                    </div>
                </div>
                ...
                <div className="relative group card bg-base-100 w-full shadow-xl overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-50 transition duration-300"></div>
                    <div className="card-body items-center text-center relative z-10 group-hover:text-white">
                        <h2 className="card-title text-lg md:text-xl font-semibold">Interior Design</h2>
                        <p className="text-sm md:text-base">If a dog chews shoes whose shoes does he choose?</p>
                    </div>
                </div>
            </div>
